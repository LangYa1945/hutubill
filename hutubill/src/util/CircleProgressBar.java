...
public class CircleProgressBar extends JPanel {//环形进度条
    ...
    public void setBackgroundColor(Color backgroundColor) {//设置背景色
    ...
    public void setForegroundColor(Color foregroundColor) {//设置前景色
